...
export default async function Home() {
  ...
  const heroBgImage = settings.hero_bg_image || 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=2000';
  const primaryColor = settings.primary_color || '#4A5D4E';
          ...
          <h1 className="font-serif text-6xl md:text-8xl text-white leading-[1.1] tracking-tighter [text-shadow:0_2px_16px_rgb(0_0_0_/_55%)]">
            {heroTitle.includes(',') ? (
              <>
                ...
                <span style={{ color: primaryColor }}>{heroTitle.split(',')[1]}</span>
              </>
            ) : heroTitle}
          </h1>
